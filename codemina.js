...
const CodeMina = function () {
    ...
    let uiHelperNumeric = function () {
        ...
        jQuery('.js-numbers-only:not(.js-numbers-only-enabled)')
    ...
    let uiHelperMultiSelect = function () {
        jQuery('.js-multiselect:not(.js-multiselect-enabled)').multiSelect({
    ...
    let uiHelperTimePicker = function () {
        jQuery('.js-timepicker:not(.js-timepicker-enabled)')
